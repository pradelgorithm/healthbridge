      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-base-content mb-6">
            Choose Your <span className="gradient-text">Health Journey</span>
          </h2>
        ...
        {/* Pricing Tabs */}
        <div className="tabs tabs-boxed justify-center mb-12 bg-base-200">
          <input type="radio" name="pricing_tabs" className="tab" aria-label="For Patients & Families" defaultChecked />
                  ...
                  <div className="card-body p-6">
                    ...
                    <div className="text-center mb-6">
                      <div className="avatar placeholder mb-3">
                        <div className={`${plan.popular ? 'bg-primary text-primary-content' : 'bg-base-200 text-base-content'} rounded-full w-12 icon-center`}>
                          {plan.icon}
                        </div>
                      </div>
          ...
          <input type="radio" name="pricing_tabs" className="tab" aria-label="For Healthcare Providers" />
          <div className="tab-content bg-base-100 border-base-300 rounded-box p-8">
            {/* Provider Plans */}
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {providerPlans.map((plan, index) => (
                <div key={index} className={`card bg-base-100 shadow-lg border-2 ${plan.popular ? 'border-secondary' : 'border-base-300'} relative`}>
                  ...
                  <div className="card-body p-6">
                    ...
                    <div className="text-center mb-6">
                      <div className="avatar placeholder mb-3">
                        <div className={`${plan.popular ? 'bg-secondary text-secondary-content' : 'bg-base-200 text-base-content'} rounded-full w-12 icon-center`}>
                          {plan.icon}
                        </div>
                      </div>
                      <h4 className="card-title text-xl justify-center">{plan.name}</h4>
